...
def gnm_dataset_transform(
    ...
    #curr_pos = tf.expand_dims(trajectory['observation']['state'][:traj_len, :2], 1)
    ...
    high, low, goal_idxs = get_goal_idxs(traj_len, min_goal_distance_prop=0.05, max_goal_distance_prop=0.5)
